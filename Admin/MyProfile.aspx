<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminMaster.master" AutoEventWireup="true" CodeFile="MyProfile.aspx.cs" Inherits="Admin_MyProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <table class="style2">
        ...
        <tr>
            <td class="style3">
                Administrative Access Level:</td>
            <td>
                <asp:Label ID="lblAdminAccess" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style3">
